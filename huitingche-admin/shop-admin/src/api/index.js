...
export const ApiGetLogin = async (phone, passwd) => {
  try {
    const res = await Axios.get(GETLOGIN, {params: {
      phone,
      passwd
    }})
    return res
...
// 新增子商城接口
export const insertEnterpriseuser = '/insertEnterpriseuser.json'
/**
 * 获取新增子商城接口
 * @param {Any} data
 */
export const ApiGetAddChildren = async (data) => {
  try {
    const res = await Axios.post(insertEnterpriseuser, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
export const ApiGetEditChildren = async (data) => {
  try {
    const res = await Axios.post(GETEDITCHILDREN, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
 ...
 * @param {Any} para
 */
export const ApiUpdateGoods = async (data, col, para) => {
  let GETUPDATEGOODS = '/updateGoods.json'
  if (col || col === 0) {
    GETUPDATEGOODS = '/updateGoods.json?col=' + col
  }
  try {
...
export const ApiExport = async (data) => {
  try {
    const url = (env === 'development' ? '/api/pdShop' + GETEXPORT : '/pdShop' + GETEXPORT) + '?' + qs.stringify(data)
    window.open(url)
    return true
  } catch (err) {
    throw new Error(err)
...
// 取消热销
export let CancelHotSale = '/getHotGoods.json?col=0'
/**
 * @param {any} data
 */
export const ApiCancelHotSale = async (id) => {
  try {
    const res = await Axios.post(CancelHotSale, id)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 根据Id查询logo
export let findLogo = '/findEnterperiseById.json'
/**
 * @param {any} data
 */
export const ApiFindLogo = async (data) => {
  try {
    const res = await Axios.get(findLogo, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 新增优惠券
export let setShopCoupon = '/setShopCoupon.json'
/**
 * @param {any} data
 */
export const ApiSetShopCoupon = async (data) => {
  try {
    const res = await Axios.post(setShopCoupon, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 查询优惠券
export let findCouponList = '/findShopCouponListByCouponStatus.json'
/**
 * @param {any} data
 */
export const ApiFindCouponList = async (data) => {
  try {
    const res = await Axios.get(findCouponList, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 新增优惠券
export let findCouponName = '/findShopCouponListByCouponName.json'
/**
 * @param {any} data
 */
export const ApiFindCouponName = async (data) => {
  try {
    const res = await Axios.post(findCouponName, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 优惠券关系接口
export let setGoodsShopCoupon = '/setGoodsShopCoupon.json'
/**
 * @param {any} data
 */
export const ApiSetGoodsShopCoupon = async (data) => {
  try {
    const res = await Axios.get(setGoodsShopCoupon, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 删除商品规格信息
export let deleteGoodsSpecification = '/deleteGoodsSpecification.json'
/**
 * @param {any} data
 */
export const ApiDeleteGoodsSpecification = async (data) => {
  try {
    const res = await Axios.get(deleteGoodsSpecification, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 上传图片
export let insertFile = '/insertFile.json'
/**
 * @param {any} data
 */
export const ApiInsertFile = async (data) => {
  try {
    const res = await Axios.post(insertFile, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 批量上传审核商品
export let URLupdateStatus = '/updateStatus.json'
/**
 * @param {any} data
 */
export const ApiUpdateStatus = async (data) => {
  try {
    const res = await Axios.get(URLupdateStatus, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 查询全部子商户
export let URLgetEnterpriseByParentId = '/getEnterpriseByParentId.json'
/**
 * @param {any} data
 */
export const ApiGetEnterpriseByParentId = async (data) => {
  try {
    const res = await Axios.get(URLgetEnterpriseByParentId, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 增加子商户销售额提点
export let URLsettingSalesPoint = '/settingSalesPoint.json'
/**
 * @param {any} data
 */
export const ApisettingSalesPoint = async (data) => {
  try {
    const res = await Axios.post(URLsettingSalesPoint, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 修改子商户销售额提点
export let URLupdateSalesPoint = '/updateSalesPoint.json'
/**
 * @param {any} data
 */
export const ApiUpdateSalesPoint = async (data) => {
  try {
    const res = await Axios.post(URLupdateSalesPoint, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 查询子商户销售额提点
export let URLgetSalesPoint = '/getSalesPoint.json'
/**
 * @param {any} data
 */
export const ApigetSalesPoint = async (data) => {
  try {
    const res = await Axios.post(URLgetSalesPoint, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 删除子商户销售额提点
export let URLdelSalesPoint = '/delSalesPoint.json'
/**
 * @param {any} data
 */
export const ApidelSalesPoint = async (data) => {
  try {
    const res = await Axios.post(URLdelSalesPoint, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 按条件查询子商户信息
export let URLgetSubEnterprise = '/getSubEnterprise.json'
/**
 * @param {any} data
 */
export const ApigetSubEnterprise = async (data) => {
  try {
    const res = await Axios.post(URLgetSubEnterprise, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 根据厂商id查询退货列表
export let URLgetRefundOrder = '/queryAllRefundRecord.json'
/**
 * @param {object} data
 */
export const ApiGetRefundOrder = async (data, page) => {
  try {
    const res = await Axios.post(URLgetRefundOrder, data, {params: page})
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 根据厂商id查询退货列表
export let URLcheckSubEnterprise = '/checkSubEnterprise.json'
/**
 * @param {object} data
 */
export const ApicheckSubEnterprise = async (data) => {
  try {
    const res = await Axios.post(URLcheckSubEnterprise, data)
    return res
  } catch (err) {
    throw new Error(err)
  }
...
// 处理退款信息
export let updateRefundRecord = '/updateRefundRecord.json'
/**
 * @param {object} data
 */
export const ApiUpdateRefundRecord = async (data) => {
  try {
    const res = await Axios.get(updateRefundRecord, {params: data})
    return res
  } catch (err) {
    throw new Error(err)
  }
